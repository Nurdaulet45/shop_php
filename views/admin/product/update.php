                ...
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <select name="is_new">
                            ...
                            <option value="0" <?php if ($product['is_new'] == 1) echo 'selected="selected"';?>>Нет</option>
                        </select>
                        ...
                        <select name="is_recommended">
                            ...
                            <option value="0" <?php if ($product['is_recommended'] == 1) echo 'selected="selected"';?>>Нет</option>
                        </select>
                        ...
                        <select name="status">
                            ...
                            <option value="0" <?php if ($product['status'] == 1) echo 'selected="selected"';?>>Скрыт</option>
                        </select>
